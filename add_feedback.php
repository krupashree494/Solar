<?php
     ...
     else if(isset($_POST['change']))
    {
        ...
        if(mysqli_query($conn, "insert into feedback(userid, feedback, status, product_id)values('$uid','$feedback',true, '$prod')"))
        {
            echo "<script>alert('Feedback added successfully..!');</script>";
        }
        else
        {
            echo "<script>alert('Unable to add feedback..!');</script>";
        }                    
    }
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                	<div class="mb-4 card p-5" style="margin-top: 190px;">
                        <div class="page-title">
                            <div class="wrapper text-center"><h1 class="page-width">Feedback</h1></div>
                        </div>
                       <form method="post" action="#">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12" style="margin-top:15px"><textarea name="feedback" cols="50" rows="5" class="form-control1" placeholder="Write your feedback" style="height: 75px;" required></textarea></div>
                        </div>
